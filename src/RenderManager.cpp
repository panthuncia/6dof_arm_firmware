...
void RenderManager::loop() {
    ...
    // overlay some info
    drawTouchscreenInfo(im, shader, meshes[meshindex]);
 ...
 **/
bool RenderManager::moveModel()  // remark: need to keep the tgx:: prefix in function signatures because arduino messes with ino files....
{
 ...
 **/
void RenderManager::drawTouchscreenInfo(tgx::Image<tgx::RGB565>& im, int shader, const tgx::Mesh3D<tgx::RGB565>* mesh)  // remark: need to keep the tgx:: prefix in function signatures because arduino messes with ino files....
{
