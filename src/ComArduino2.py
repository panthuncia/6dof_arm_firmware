...
def runTest(td):
  ...
  while n < numLoops:
    ...
    teststr = td[n].encode(ascii)
    print("sending "+str(teststr));

    if waitingForReply == False:
      sendToArduino(teststr)
      print("Sent from PC -- LOOP NUM " + str(n) + " TEST STR " + str(teststr))
